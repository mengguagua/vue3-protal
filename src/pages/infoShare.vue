...
<script>
// import {newsTypeList, newsDetailList} from '/src/service/interface';
export default {
  name: 'App',
  data() {
    return {
...
.top-image {
  position: relative;
  background: url('/src/assets/images/banner-infoShare.png') no-repeat;
  ...
  .content-line {
    ...
    .block-line {
      ...
      .item {
        ...
        .img1 {
          background: url('/src/assets/images/info-1.png') no-repeat;
          background-size: 100% 100%;
        }
        .img2 {
          background: url('/src/assets/images/info-2.png') no-repeat;
          background-size: 100% 100%;
        }
        .img3 {
          background: url('/src/assets/images/info-3.png') no-repeat;
          background-size: 100% 100%;
        }
        .img4 {
          background: url('/src/assets/images/info-4.png') no-repeat;
          background-size: 100% 100%;
        }
        .img5 {
          background: url('/src/assets/images/info-5.png') no-repeat;
          background-size: 100% 100%;
        }
        .img6 {
          background: url('/src/assets/images/info-6.png') no-repeat;
          background-size: 100% 100%;
        }
      }
    }
