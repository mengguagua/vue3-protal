      ...
      div
        ...
        div.content
          iframe(src="http://www.baidu.com/"
            width="1200px" height="3000px" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no")
    Footer
</template>
...
.top-image {
  position: relative;
  background: url('/src/assets/images/banner-operate.png') no-repeat;
