...
<script>
// import {newsTypeList, newsDetailList, userLogin} from '/src/service/interface';
export default {
  name: 'App',
  data() {
    return {
...
.top-image {
  position: relative;
  background: url('/src/assets/images/banner-risk.png') no-repeat;
...
.first2-content {
  ...
  .content-line {
    margin-top: 30px;
    background: url('/src/assets/images/online-back-3.png') no-repeat;
    background-size: 100% 100%;
    width: 1200px;
    height: 350px;
    .tip {
...
.four-content {
  ...
  .content-line {
    ...
    .item {
      ...
      border-radius: 2px;
      //box-shadow: 0 0 4px 2px #F4F9FE;
      background: url('/src/assets/images/online-back-2.png') no-repeat;
      background-size: 100% 100%;
      &:hover {
...
.third-content {
  ...
  .map {
    ...
    width: 1270px;
    height: 540px;
    background: url('/src/assets/images/fourth-back.png') no-repeat;
    background-size: 100% 100%;
    .list {
      display: flex;
